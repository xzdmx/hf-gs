...
##--input_rgb_dir ../data/${dataset}/colmap_dir/${scene}/images
##--input_mask_dir ../output/${dataset}/${scene}/mask/sub_mask
##--input_mask_dir ../data/${dataset}/colmap_dir/${scene}/seg
##--input_mask_dir ../output/${dataset}/${scene}/mask/seg_expand_ablation
##--output_dir ../output/${dataset}/${scene}/inpainted_images_ablation
python diffuse_images.py \
        --input_rgb_dir ../output/${dataset}/${scene}/train/ours_1/renders \
        --input_mask_dir ../output/${dataset}/${scene}/mask/sub_mask \
        --output_dir ../output/${dataset}/${scene}/inpainted_images_dir \
        --diffuse_checkpoints $diffuse_checkpoints_path \
        --model_path ../output/${dataset}/${scene} \
        --prompt 'stone surface'
#        --negative_prompt ""
